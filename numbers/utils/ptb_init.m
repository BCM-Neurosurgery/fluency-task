...
% define the margin from the borders to plot the dots on the line
margin = screenXpixels*.15; % 20% of margin from the borders

% define the size of the dot in pixels 
stimSizePx = [round(opt.stimSizeDeg / degPerPx), round(opt.stimSizeDeg / degPerPx)];
